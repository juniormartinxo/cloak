...
This project is indexed by GitNexus as **cloak** (1225 symbols, 2753 relationships, 107 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
